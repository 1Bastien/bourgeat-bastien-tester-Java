...
public class DBConstants {
    ...
    public static final String GET_NB_TICKET = "select count(*) as nbTicket from ticket t, join parking p on p.parking_number = t.parking_number where t.VEHICLE_REG_NUMBER=?";
}
